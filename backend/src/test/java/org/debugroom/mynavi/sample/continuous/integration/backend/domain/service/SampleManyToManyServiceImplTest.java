    ...
    public static class UnitTest{
        ...
        public void setUp(){
            ...
            User mockUser1 = User.builder()
                    .userId(0)
                    .membershipsByUserId(Arrays.asList(new Membership[]{mockMembership}))
                    .build();
    ...
    public static class IntegrationTest{
        ...
        public void getUserOfGroupNormalTest(){
            ...
            users.stream().forEach(user -> {
                assertThat(user.getFirstName(), is("jiro"));
            });
        }
        ...
        public void getUserOfNotGroupNormalTest(){
            ...
            assertThat(users.size(), is(1));
            users.stream().forEach(user -> {
                assertThat(user.getFirstName(), is("hanako"));
            });
        }
