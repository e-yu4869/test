...
public class SampleServiceImplTest {
    ...
    public static class UnitTest{
        ...
        public void setUp(){
            ...
            User updateUser = User.builder()
                    ...
                    .emailsByUserId(Arrays.asList(new Email[]{updateEmail}))
                    .ver(0)
                    .build();
            ...
            when(userRepositoryMock.getMaxUserId()).thenReturn(new Long(1));
       }
        ...
        public void addTestNormalCase() throws BusinessException{
            ...
            User addUser = User.builder()
                    ...
                    .emailsByUserId(Arrays.asList(new Email[]{addEmail1, addEmail2}))
                    .membershipsByUserId(Arrays.asList(new Membership[]{addMembership}))
                    .ver(0)
                    .build();
    ...
    public static class IntegrationTest{
        ...
        public void findOneNormalTest() throws BusinessException{
            User user = sampleService.findOne(
                    User.builder().userId(new Long(0)).build());
        ...
        public void updateNormalTest() throws BusinessException{
            ...
            User updateUser = User.builder()
                    ...
                    .isLogin(false)
                    .addressByUserId(updateAddress)
                    .emailsByUserId(Arrays.asList(new Email[]{updateEmail1, updateEmail2}))
                    .build();
            sampleService.update(updateUser);
        }
